...
<head>
  ...
  <style>
    body { margin: 0; padding: 0; background-color: #071322; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; color: #ffffff; }
    ...
    .brand { color: #C6A98A; font-size: 13px; font-weight: 700; letter-spacing: 3px; text-transform: uppercase; margin-bottom: 6px; }
