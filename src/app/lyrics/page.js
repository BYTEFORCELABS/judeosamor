    ...
    <div className="min-h-screen bg-[#071322] text-white flex flex-col selection:bg-[#C6A98A] selection:text-black">
      ...
      <main className="flex-grow pt-28 pb-20">
        ...
        <section className="relative px-4 sm:px-6 lg:px-8 py-12 max-w-7xl mx-auto text-center space-y-5 overflow-hidden">
          {/* Ambient Lighting */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[550px] h-[300px] bg-[#C6A98A]/10 blur-[140px] pointer-events-none rounded-full" />
          ...
          <div className="pt-6 max-w-3xl mx-auto space-y-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-3.5 bg-zinc-950/90 border border-zinc-800 rounded-none text-sm text-white placeholder:text-zinc-500 focus:outline-none focus:border-[#C6A98A] shadow-xl"
              />
            </div>
                ...
                return (
                  <button
                    ...
                    className={`px-4 py-1.5 text-xs font-semibold uppercase tracking-wider transition-all duration-200 cursor-pointer ${
                      isActive
                        ? "bg-[#C6A98A] text-black shadow-md scale-105 font-bold"
                    ...
                    return (
                      <div
                        ...
                        className={`p-4 rounded-none cursor-pointer transition-all duration-200 border text-left ${
                          isSelected
                            ? "bg-zinc-900 border-[#C6A98A] shadow-lg translate-x-1"
                          ...
                          <div className="space-y-1">
                            <h4
                              className={`font-fjalla text-base sm:text-lg uppercase tracking-wide font-bold transition-colors ${
                                isSelected ? "text-[#C6A98A]" : "text-white"
                              }`}
                            >
                              {song.title}
                            </h4>
                ...
                {selectedSong ? (
                  <div className="space-y-8 relative z-10">
                    ...
                    <div className="border-b border-zinc-800/80 pb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                      <div className="space-y-2">
                        <div className="flex items-center gap-2">
                          <span className="px-2.5 py-0.5 bg-[#C6A98A]/15 border border-[#C6A98A]/30 text-[#C6A98A] text-xs font-bold uppercase tracking-wider">
                      ...
                      <div className="flex items-center gap-3 flex-shrink-0">
                        ...
                        {hasLyrics && (
                          ...
                          >
                            <Copy className="w-4 h-4 text-[#C6A98A]" />
                        ...
                        {videoId && (
                          <button
                            ...
                            className="flex items-center gap-2 px-4 py-2.5 bg-[#C6A98A] hover:bg-[#A89075] text-black text-xs uppercase font-bold tracking-wider rounded-none transition-colors shadow cursor-pointer"
                          >
                            {isPlaying ? (
                              <>
                    ...
                    {isPlaying && videoId && (
                      <div className="sticky top-24 z-20 -mx-6 sm:-mx-10 px-6 sm:px-10 pb-4 bg-zinc-950/95 backdrop-blur-md border-b border-zinc-800/80">
                        ...
                        <div className="flex items-center justify-between gap-3 pt-2.5">
                          <p className="text-[11px] uppercase tracking-widest font-bold text-[#C6A98A]">
                            Now Playing
                          </p>
                          <a
                    ...
                    <div className="pt-8 border-t border-zinc-900 text-xs text-zinc-500 text-center">
                      &copy; {selectedSong.releaseYear} Minister Lilian Nneji Ministries. All rights reserved. For live performance licenses and sheet music enquiries, contact <a href="mailto:bookings@liliannneji.com" className="text-[#C6A98A] hover:underline">bookings@liliannneji.com</a>.
                    </div>
