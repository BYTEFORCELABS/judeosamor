...
export default function ReverbPage() {
  ...
  return (
    <div className="min-h-screen bg-[#071322] text-white flex flex-col font-sans">
      <Navbar />
                  ...
                  <div className="p-8 sm:p-10 rounded-2xl bg-blue-950/80 border border-blue-400/40 text-center space-y-4 animate-in fade-in shadow-2xl">
                    ...
                    {ticketCode && (
                      <div className="inline-block px-5 py-2.5 rounded-lg bg-blue-900/60 border border-blue-400/50 my-2">
                        ...
                        <span className="text-2xl font-mono font-black text-[#C6A98A] tracking-wider">
                          {ticketCode}
                        </span>
                      </div>
                    )}
      ...
      <footer className="bg-black py-12 text-center space-y-7">
        ...
        <div className="flex items-center justify-center gap-6 sm:gap-7 text-[#C6A98A]">
        ...
        <div className="pt-1 flex justify-center">
          <div className="bg-[#C6A98A] text-black font-bold text-xs sm:text-sm px-6 py-2 rounded-none shadow-md">
