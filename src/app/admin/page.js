...
export default function AdminDashboardPage() {
  ...
  if (!isAuthenticated) {
    return (
      <div className="min-h-screen bg-black text-white flex items-center justify-center p-4 selection:bg-[#C6A98A] selection:text-black">
        <div className="w-full max-w-md bg-zinc-950 border border-zinc-800 rounded-2xl p-8 space-y-6 shadow-2xl">
          <div className="text-center space-y-3">
            ...
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#C6A98A]/10 border border-[#C6A98A]/30 text-[#C6A98A] text-xs uppercase font-bold tracking-wider">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-zinc-900 border border-zinc-700 rounded-lg text-white placeholder:text-zinc-500 text-sm focus:outline-none focus:ring-2 focus:ring-[#C6A98A]"
              />
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 rounded-lg bg-[#C6A98A] hover:bg-[#A89075] text-black font-bold uppercase tracking-wider text-xs transition-colors shadow-lg active:scale-95 cursor-pointer"
            >
  ...
  return (
    <div className="min-h-screen bg-black text-white selection:bg-[#C6A98A] selection:text-black">
        ...
        <nav className="flex-grow overflow-y-auto py-3 px-2 space-y-0.5">
          {NAV_ITEMS.map((item) => {
            ...
            return (
              ...
              >
                {isActive && (
                  <span className="absolute left-0 top-1.5 bottom-1.5 w-0.5 rounded-full bg-[#C6A98A]" />
                )}
                <Icon className={`w-4 h-4 flex-shrink-0 ${isActive ? "text-[#C6A98A]" : ""}`} />
          ...
          <div className="space-y-10">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="mt-2 flex items-end justify-between">
                      ...
                      <ArrowUpRight className="w-4 h-4 text-zinc-700 group-hover:text-[#C6A98A] transition-colors" />
                    </div>
                  </button>
                );
              })}
            ...
            <section className="space-y-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                >
                  <Plus className="w-4 h-4 text-[#C6A98A] flex-shrink-0" />
                  <div>
              ...
              <div className="rounded-lg border border-zinc-800/60 bg-zinc-950 divide-y divide-zinc-800/60">
                {PUBLIC_LINKS.map((link) => (
                  ...
                  >
                    ...
                    <ExternalLink className="w-3.5 h-3.5 text-zinc-600 group-hover:text-[#C6A98A] transition-colors" />
                  </Link>
                ))}
              </div>
            </section>
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
              ...
              <div className="relative flex-grow max-w-md">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 bg-zinc-950 border border-zinc-800 rounded-lg text-xs sm:text-sm text-white placeholder:text-zinc-500 focus:outline-none focus:border-[#C6A98A]"
                />
              </div>
                      ...
                      filteredAttendees.map((attendee) => {
                        ...
                        return (
                          <tr key={attendee.id} className="hover:bg-zinc-900/50 transition-colors">
                            <td className="py-3.5 px-4 font-mono font-bold text-[#C6A98A]">
                              {attendee.ticketCode}
                            </td>
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4">
              <div>
                ...
                <p className="text-xs text-zinc-400">
                  Manage photos displayed on the public <Link href="/gallery" target="_blank" className="text-[#C6A98A] hover:underline">/gallery</Link> showcase.
                </p>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-2 bg-[#C6A98A] hover:bg-[#A89075] text-black text-sm font-medium rounded-md transition-colors cursor-pointer"
                >
          ...
          <div className="space-y-6">
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4">
              <div>
                ...
                <p className="text-xs text-zinc-400">
                  Manage song lyrics and catalog published on the public <Link href="/lyrics" target="_blank" className="text-[#C6A98A] hover:underline">/lyrics</Link> repository.
                </p>
              </div>
            ...
            <form onSubmit={handleSavePhoto} className="space-y-4">
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 bg-zinc-900 border border-zinc-800 rounded-lg text-sm text-white focus:outline-none focus:border-[#C6A98A]"
                />
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  ...
                  <select
                    ...
                    className="w-full px-3.5 py-2.5 bg-zinc-900 border border-zinc-800 rounded-lg text-sm text-white focus:outline-none focus:border-[#C6A98A] cursor-pointer"
                  >
                    {GALLERY_CATEGORIES.map((cat) => (
                      <option key={cat} value={cat}>{cat}</option>
                    ))}
                      ...
                      <button
                        ...
                        className={`text-[10px] px-2 py-0.5 rounded cursor-pointer transition-colors ${
                          photoForm.imageUrl === preset.path
                            ? "bg-[#C6A98A] text-black font-bold"
              ...
              <div className="space-y-1.5">
                ...
                <textarea
                  ...
                  className="w-full px-3.5 py-2.5 bg-zinc-900 border border-zinc-800 rounded-lg text-sm text-white focus:outline-none focus:border-[#C6A98A] resize-none"
                />
              </div>
              ...
              <div className="pt-2 flex items-center justify-end gap-3 border-t border-zinc-800">
                ...
                <button
                  type="submit"
                  className="px-4 py-2 bg-[#C6A98A] hover:bg-[#A89075] text-black rounded-md text-sm font-medium cursor-pointer"
                >
            ...
            <form onSubmit={handleSaveLyrics} className="space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <textarea
                  ...
                  className="w-full px-3.5 py-2.5 bg-zinc-900 border border-zinc-800 rounded-lg text-sm text-white font-mono focus:outline-none focus:border-[#C6A98A] leading-relaxed"
                />
              </div>
        ...
        <div className="fixed inset-0 z-50 bg-black/85 backdrop-blur-sm flex items-center justify-center p-4 overflow-y-auto">
          <div className="bg-zinc-950 border border-zinc-800 rounded-2xl max-w-2xl w-full p-6 sm:p-8 space-y-4 shadow-2xl animate-in fade-in my-8 max-h-[85vh] flex flex-col justify-between">
            <div className="flex items-center justify-between border-b border-zinc-800 pb-3 flex-shrink-0">
              <div>
                <span className="text-[11px] font-bold uppercase tracking-wider text-[#C6A98A]">
