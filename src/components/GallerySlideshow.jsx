...
export default function GallerySlideshow({ items = [] }) {
  ...
  return (
    <section id="gallery" className="relative bg-black py-24 sm:py-28 border-t border-white/5 overflow-hidden">
      <div className="absolute top-1/3 -right-20 w-[420px] h-[420px] rounded-full bg-[#C6A98A]/[0.06] blur-[130px] pointer-events-none animate-breathe" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-5 mb-10">
          <div className="space-y-3">
            <Reveal as="h2" variant="wipe" className="font-fjalla text-4xl sm:text-6xl lg:text-7xl text-[#C6A98A] font-bold uppercase tracking-tight leading-[0.95]">
              Moments of Glory
            </Reveal>
          </div>
          ...
          <Reveal variant="up" delay={140}>
            <Link
              href="/gallery"
              className="group inline-flex items-center gap-2 text-sm font-semibold uppercase tracking-wider text-zinc-300 hover:text-[#C6A98A] transition-colors link-underline"
            >
              View Full Gallery
            ...
            >
              ...
              <div key={active} className="absolute bottom-0 inset-x-0 p-5 sm:p-8 z-10">
                <div data-reveal="up" data-revealed="true" className="space-y-2 max-w-2xl">
                  <span className="inline-block px-2.5 py-1 bg-[#C6A98A] text-black text-[10px] font-bold uppercase tracking-widest">
                    {current.category}
                  </span>
              ...
              <button
                ...
                className="absolute left-3 top-1/2 -translate-y-1/2 z-20 p-2.5 bg-black/50 hover:bg-[#C6A98A] text-white hover:text-black backdrop-blur-md transition-all duration-300 opacity-0 group-hover:opacity-100 focus-visible:opacity-100 -translate-x-2 group-hover:translate-x-0 cursor-pointer"
              >
              ...
              <button
                ...
                className="absolute right-3 top-1/2 -translate-y-1/2 z-20 p-2.5 bg-black/50 hover:bg-[#C6A98A] text-white hover:text-black backdrop-blur-md transition-all duration-300 opacity-0 group-hover:opacity-100 focus-visible:opacity-100 translate-x-2 group-hover:translate-x-0 cursor-pointer"
              >
                ...
                return (
                  <button
                    ...
                    className={`relative flex-shrink-0 w-28 lg:w-full aspect-[4/3] overflow-hidden border transition-all duration-300 cursor-pointer ${
                      isActive
                        ? "border-[#C6A98A] opacity-100 scale-[1.02]"
                  ...
                  >
                    <Image
                      ...
                      className="object-cover"
                    />
                    {isActive && <span className="absolute inset-x-0 bottom-0 h-0.5 bg-[#C6A98A]" />}
                  </button>
                );
              })}
              </div>
