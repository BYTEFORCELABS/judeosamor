...
export default function MinistryStats() {
  ...
  return (
    <section className="relative py-12 border-y border-[rgba(198, 169, 138,0.18)] bg-gradient-to-b from-[#071322] via-[#081729] to-[#071322]">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
          {stats.map((stat, idx) => {
            ...
            return (
              ...
              >
                <div className="w-12 h-12 mx-auto rounded-xl bg-[#C6A98A]/10 border border-[#C6A98A]/30 flex items-center justify-center text-[#DAC8B3] group-hover:scale-110 transition-transform">
