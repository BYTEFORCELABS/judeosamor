      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {streamingPlatforms.map((platform, idx) => {
              ...
              return (
                <Reveal
                  ...
                  className="flex items-center gap-2 hover:text-[#C6A98A] hover:-translate-y-0.5 transition-all duration-300 group"
                >
                  <Icon className="w-4 h-4 text-zinc-300 group-hover:text-[#C6A98A] transition-colors flex-shrink-0" />
        ...
        <div className="mb-20 sm:mb-24">
          <div className="text-center mb-10">
            <Reveal as="h3" variant="up" className="font-fjalla text-4xl sm:text-6xl text-[#C6A98A] uppercase tracking-wide font-bold">
              MUSIC VIDEOS
            </Reveal>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-6">
            {musicVideos.map((video, idx) => (
              <Reveal
                ...
                className="group relative aspect-video rounded-sm overflow-hidden bg-zinc-900 cursor-pointer shadow-lg hover:shadow-2xl border border-zinc-800/80 hover:border-[#C6A98A]/50 hover:-translate-y-1.5 transition-all duration-300"
              >
                {/* Thumbnail Image */}
                <Image
                  src={video.thumbnail}
